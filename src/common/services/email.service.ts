  ...
  private generateOrderShippedEmail(data: EmailData): string {
    ...
    return `
      ...
      <head>
        <meta charset="utf-8">
        <meta name="viewport" content="width=device-width, initial-scale=1.0">
        <title>Order Shipped - Rikhh</title>
        <style>
          * {
            margin: 0;
            padding: 0;
        ...
        <div class="email-container">
          ...
          <div class="content">
            ...
            <div class="cta-section">
              ...
              ` : ''}
              <a href="${process.env.FRONTEND_URL || 'https://rikhh.com'}/orders/${data.orderNumber}" class="cta-button">
                View Order Details
              </a>
            </div>
          ...
          <div class="footer">
            ...
            <p>Email: support@rikhh.com | Phone: +1 (555) 123-4567</p>
            ...
            <p style="margin-top: 20px; font-size: 12px; opacity: 0.6;">
              © 2025 Rikhh. All rights reserved.<br>
              This email was sent to ${data.customerEmail}
            </p>
          </div>
        </div>
    ...
    return `
      ...
      <body>
        <div class="container">
          ...
          <div class="footer">
            <p>Thank you for choosing Rikkh!</p>
            <p>If you have any questions, please contact us at support@rikhh.com</p>
            <p>© 2025 Rikhh. All rights reserved.</p>
          </div>
        </div>
      </body>
      </html>
