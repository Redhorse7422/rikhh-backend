...
export class DbUpdateSchemawithoutshipping1754410732599 implements MigrationInterface {
    name = 'DbUpdateSchemawithoutshipping1754410732599'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "order_status_history" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "orderId" uuid NOT NULL, "status" "public"."order_status_enum" NOT NULL DEFAULT 'pending', "changedBy" uuid, "notes" text, "notificationSent" boolean NOT NULL DEFAULT false, "previousStatus" "public"."order_status_enum" DEFAULT 'pending', CONSTRAINT "PK_e6c66d853f155531985fc4f6ec8" PRIMARY KEY ("id"))`);
